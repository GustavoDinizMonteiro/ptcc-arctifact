...
\section{The Problem}
Organizations with varying and peak demand patterns often resort to public clouds to meet unexpected or short-term needs and avoid failures to meet business demands and quality of service goals. However, outside of peak times, the resources belonging to these organizations may become inactive, which is a loss of efficiency. Under these circumstances, selling these surplus resources may be an interesting option for large private cloud providers, but not for smaller private providers.

\section{Objectives}
The objective of this work is the implementation of a system of provisioning a favors network, which functions as a guarantor of justice, and which will function in a pluggable way, both in the sense that it can be added to a federation provider as a component that provides the network of favors as well as in the sense of perpetuating the use of various implementations of reciprocity algorithms.
