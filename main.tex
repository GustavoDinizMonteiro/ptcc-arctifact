...
\section{Objectives}
The objective of this work is the implementation of an existing proposal of a mediator in a P2P network that would function as an implementor of a fair favors network.
